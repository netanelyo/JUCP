...
//	}
	...
	private static native long createCtxNative(/*int eventQueueSize, Object dataFromC*/);

	public static long createCtx(EventQueueHandler eqh, int eventQueueSize, EventQueueHandler.DataFromC dataFromC) {
		return createCtxNative();
