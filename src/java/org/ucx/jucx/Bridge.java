...
//	}
	...
	public static long createCtx(UCPParams params) {
...
//		Bridge.mapIdEQHObject.remove(ptrCtx);
	...
	public static long createWorker(long ctxID) {
		return createWorkerNative(ctxID);
	}
	
	public static native void testerNative(byte[] arr, long id);
	
	private static native byte[] getWorkerAddressNative(long workerID, long[] ret);
	
	public static byte[] getWorkerAddress(long workerNativeID, long[] ret) {
