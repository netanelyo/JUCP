...
public:
	...
	int writeOnSessionErrorEvent(char *buf, void *ptrForJava,
			struct xio_session_event_data *event_data);
	int writeOnSessionEstablishedEvent(char *buf, void *ptrForJava,
	...
	int writeOnMsgErrorEventServer(char *buf, void *ptrForJavaMsg,
			void *ptrForJavaSession, enum xio_status error);
	int writeOnMsgErrorEventClient(char *buf, void *ptrForJava,
			enum xio_status error);
	int writeOnRequestReceivedEvent(char *buf, void *ptrForJavaMsg,
			const int32_t msg_in_size, const int32_t msg_out_size,
			void *ptrForJavaSession);
	int writeOnResponseReceivedEvent(char *buf, void *ptrForJavaMsg,
